...
if ( ! function_exists( 'bootstrapwp_posted_on' ) ) :
	...
	function bootstrapwp_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'bootstrapwp' ),
...
if ( ! function_exists( 'bootstrapwp_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function bootstrapwp_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'bootstrapwp' ),
